...
import { CheckCircle, ExternalLink, Share2, Clock, RotateCcw, StickyNote, History, Pencil, Trash2 } from 'lucide-react';
...
const SharedExpenses: React.FC<SharedExpensesProps> = ({ expenses, onSettle, onUnsettle, currency, onEdit, onDelete }) => {
