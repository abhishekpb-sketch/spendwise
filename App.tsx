...
import { Home, Share2, Settings as SettingsIcon, Plus, X } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [category, setCategory] = useState<string>(settings.categories[0] || DEFAULT_CATEGORIES[0]);
